...
<head>
    ...
    <link rel="stylesheet" href="${cp}/css/agendaProfissional.css">
    <link rel="icon" href="../4.23-Agenda Profissional/img - Agenda Profissional/icon-conecta.svg" type="image/x-icon">
    <script defer src="${cp}/js/agendaProfissional.js"></script>
...
<body>
    ...
    <div id="sidebar" class="sidebar">
        ...
        <div class="menu">
            ...
            <a href="/Dash-Profissional/UC4.08-Lista de Serviços Cadastrados Profissional/lista-Servicos.html">
                <i class="fas fa-history"></i>
        ...
        <div class="minha-agenda">
            <div class="agenda">
                <jsp:useBean
                    id="servicos"
                    scope="page"
                    class="agenda.services.AgendamentoServices"/>
                    ...
                    <c:forEach items="${servicos.todos}" var="agendamentos">
                        ...
                        <div class="service" id="service-1">
                            ...
                            <p>Data: ${agendamentos.data} </p>
                            <p>Horário: ${agendamentos.horario} </p>
                            <button class="complete-btn" onclick="markAsCompleted(this)">Serviço realizado</button>
                        </div>
