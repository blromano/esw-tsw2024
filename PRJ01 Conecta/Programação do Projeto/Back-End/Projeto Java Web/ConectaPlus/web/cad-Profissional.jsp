...
<head>
    ...
    <link rel="stylesheet" href="${cp}../Front-end/Paginas Primarias
                                    /UC4.18 - Fazer Cadastro Profissional/cad-prof.css">
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery.mask/1.14.16/jquery.mask.min.js"></script>
    <link rel="icon" href="${cp}../Front-end/Paginas Primarias/selec-TipoCadastro
                                /img - Fazer Cadastros/icon-conecta.svg" type="image/x-icon">
