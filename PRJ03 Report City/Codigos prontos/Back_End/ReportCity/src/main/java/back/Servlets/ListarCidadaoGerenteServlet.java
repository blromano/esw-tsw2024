 ...
 * @author nicho
 */
@WebServlet(name = "ListarCidadaoGerenteServlet", urlPatterns = {"/pListarCidadaoGerente"})
public class ListarCidadaoGerenteServlet extends HttpServlet {
